...
class Employee(models.Model):
  ...
  warehouse = models.ForeignKey('warehouses.Warehouse', on_delete=models.CASCADE, db_column='warehouse_id')
  ...
  job_position = models.ForeignKey('job_positions.JobPosition', on_delete=models.SET_NULL, db_column='job_position_id', null=True, blank=True)

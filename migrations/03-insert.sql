...
(1, 'Ferretería San Juan S.A.', '20123456789', 'contacto@ferresanjuan.com', '015678901', 'Av. Universitaria 1234, Lima, Perú', 1, 1),
(2, 'Materiales del Norte SAC', '20456789012', 'ventas@matnorte.com', '016543210', 'Calle Comercio 456, Trujillo, Perú', 1, 1);
...
(1, 1, 'Sucursal Lima', 'Av. Aviación 2345, Lima, Perú', '014567890', 1, 1),
(2, 1, 'Sucursal Arequipa', 'Calle Mercaderes 789, Arequipa, Perú', '054678901', 1, 1),
(3, 1, 'Sucursal Cusco', 'Av. El Sol 555, Cusco, Perú', '084567123', 1, 1),
(4, 1, 'Sucursal Chiclayo', 'Calle Balta 789, Chiclayo, Perú', '074678345', 1, 1),
(5, 2, 'Sucursal Trujillo', 'Av. América Norte 123, Trujillo, Perú', '044345678', 1, 1),
(6, 2, 'Sucursal Piura', 'Av. Grau 432, Piura, Perú', '073567890', 1, 1),
(7, 2, 'Sucursal Tacna', 'Jr. Bolognesi 210, Tacna, Perú', '052678234', 1, 1),
(8, 2, 'Sucursal Huancayo', 'Calle Real 678, Huancayo, Perú', '064345789', 1, 1);
...
(1, 1, 'Almacén Central Lima', 'Almacén principal en Lima', 'Av. Aviación 2345, Lima, Perú', 1, 1),
(2, 1, 'Depósito Lima', 'Depósito de materiales', 'Calle Industrial 567, Lima, Perú', 1, 1),
(3, 2, 'Almacén Arequipa', 'Centro de distribución en el sur', 'Calle Mercaderes 789, Arequipa, Perú', 1, 1),
(4, 3, 'Almacén Cusco', 'Depósito de herramientas en Cusco', 'Av. El Sol 555, Cusco, Perú', 1, 1),
(5, 4, 'Almacén Chiclayo', 'Depósito de ferretería en Chiclayo', 'Calle Balta 789, Chiclayo, Perú', 1, 1),
(6, 5, 'Almacén Trujillo', 'Almacén central en Trujillo', 'Av. América Norte 123, Trujillo, Perú', 1, 1),
(7, 6, 'Almacén Piura', 'Depósito de materiales en Piura', 'Av. Grau 432, Piura, Perú', 1, 1),
(8, 7, 'Almacén Tacna', 'Centro de distribución en Tacna', 'Jr. Bolognesi 210, Tacna, Perú', 1, 1),
(9, 8, 'Almacén Huancayo', 'Depósito de herramientas en Huancayo', 'Calle Real 678, Huancayo, Perú', 1, 1);
...
(1, 'Lenin Josue', 'Monrroy', 'Vasquez', 'https://example.com/photos/gloria.jpg', 1,
 ...
 'Jr. Ayacucho 369, Chorrillos, Lima', '2025-01-01', 1, 4500.00, 1),
(2, 'Juan Carlos', 'González', 'Pérez', 'https://example.com/photos/juan.jpg', 1,
 ...
 'Av. Larco 123, Miraflores, Lima', '2015-08-10', 3, 7500.00, 1),
(3, 'María Elena', 'Rodríguez', 'Lopez', 'https://example.com/photos/maria.jpg', 2,
 ...
 'Calle Los Cedros 456, San Isidro, Lima', '2018-05-20', 5, 4800.00, 1),
(4, 'Pedro Luis', 'Fernández', 'Castro', 'https://example.com/photos/pedro.jpg', 3,
 ...
 'Jr. Amazonas 789, Ate, Lima', '2010-09-15', 6, 5500.00, 1),
(5, 'Ana Gabriela', 'Salazar', 'Torres', 'https://example.com/photos/ana.jpg', 4,
 ...
 'Urb. Santa Anita, Lima', '2020-02-01', 4, 3200.00, 1),
(6, 'Luis Eduardo', 'Cárdenas', 'Reyes', 'https://example.com/photos/luis.jpg', 5,
 ...
 'Av. Grau 456, Barranco, Lima', '2016-07-18', 1, 4600.00, 1),
(7, 'Carmen Rosa', 'Mendoza', 'Flores', 'https://example.com/photos/carmen.jpg', 6,
 ...
 'Calle Primavera 123, Surco, Lima', '2019-11-23', 5, 5200.00, 1),
(8, 'Jorge Andrés', 'Vargas', 'Ramos', 'https://example.com/photos/jorge.jpg', 7,
 ...
 'Calle Los Olivos 789, San Juan de Lurigancho, Lima', '2005-03-10', 2, 12000.00, 1),
(9, 'Patricia Verónica', 'Ortiz', 'Fernández', 'https://example.com/photos/patricia.jpg', 8,
 ...
 'Av. Canadá 789, La Victoria, Lima', '2022-06-12', 7, 1800.00, 1),
(10, 'Ricardo Antonio', 'Sánchez', 'Gómez', 'https://example.com/photos/ricardo.jpg', 9,
 ...
 'Jr. Tupac Amaru 456, Rimac, Lima', '2014-12-05', 1, 6800.00, 1),
(11, 'Silvia Beatriz', 'Chávez', 'Rivas', 'https://example.com/photos/silvia.jpg', 1,
 ...
 'Calle San Felipe 321, Magdalena, Lima', '2017-09-30', 6, 5400.00, 1),
(12, 'José Fernando', 'Navarro', 'Soto', 'https://example.com/photos/jose.jpg', 2,
 ...
 'Av. Universitaria 852, Los Olivos, Lima', '2007-04-28', 3, 8200.00, 1),
(13, 'Gloria Elisabeth', 'Rojas', 'Espinoza', 'https://example.com/photos/gloria.jpg', 3,
 ...
 'Jr. Ayacucho 369, Chorrillos, Lima', '2021-01-14', 6, 4500.00, 1);
...
(1, 'Herramientas Manuales', 'Categoría para herramientas como martillos, destornilladores, llaves, etc.', 1, 1),
(2, 'Herramientas Eléctricas', 'Categoría para taladros, sierras eléctricas, lijadoras y otras herramientas eléctricas.', 1, 1),
(3, 'Materiales de Construcción', 'Materiales como cemento, ladrillos, arena y piedra.', 1, 1),
(4, 'Pinturas y Acabados', 'Pinturas, barnices, brochas, rodillos y accesorios para acabados.', 1, 1),
(5, 'Plomería', 'Tubos, conexiones, válvulas, llaves de paso y artículos de plomería.', 1, 1),
(6, 'Electricidad', 'Cables, enchufes, interruptores, luminarias y artículos eléctricos.', 1, 1),
(7, 'Jardinería', 'Herramientas de jardinería, fertilizantes, semillas y macetas.', 1, 1),
(8, 'Seguridad Industrial', 'Cascos, guantes, gafas de seguridad y ropa reflectante.', 1, 1),
(9, 'Adhesivos y Selladores', 'Siliconas, pegamentos, masillas y selladores de todo tipo.', 1, 1),
(10, 'Tornillería y Fijaciones', 'Tornillos, clavos, pernos, tuercas y arandelas.', 1, 1),
(11, 'Cerraduras', 'Cerraduras para puertas de todo tipo, incluyendo residenciales y comerciales.', 1, 1),
(12, 'Ferretería General', 'Bisagras, rieles, soportes y artículos generales.', 1, 1),
(13, 'Automatización y Domótica', 'Motores, sistemas de automatización y dispositivos de domótica.', 1, 1),
(14, 'Maquinaria Pesada', 'Pequeña maquinaria como mezcladoras, compactadoras y otros equipos.', 1, 1),
(15, 'Accesorios para Baño y Cocina', 'Grifería, accesorios para baño y artículos para cocina.', 1, 1),
(16, 'Vidrio y Acrílicos', 'Cristales, acrílicos y materiales relacionados.', 1, 1),
(17, 'Equipos de Medición', 'Cintas métricas, niveles, calibradores y otros instrumentos de medición.', 1, 1),
(18, 'Maderas y Derivados', 'Tablas, triplay, MDF y otros derivados de madera.', 1, 1),
(19, 'Sistemas de Riego', 'Tuberías, aspersores y equipos para riego.', 1, 1),
(20, 'Calentadores y Climatización', 'Calentadores, ventiladores y aire acondicionado.', 1, 1),
(21, 'Candados', 'Candados de seguridad de diferentes niveles de protección.', 1, 1),
(22, 'Cilindros', 'Cilindros para cerraduras y sistemas de seguridad.', 1, 1),
(23, 'Cerrojos', 'Sistemas de cerrojos manuales y automáticos.', 1, 1),
(24, 'Accesorios de Cerrajería', 'Componentes y accesorios para sistemas de cerrajería.', 1, 1);

-- Insertar datos en la tabla brands
INSERT INTO `brands` (id, name, description, logo_url, website_url, status, created_by) VALUES
(1, 'DeWalt', 'Fabricante de herramientas eléctricas y accesorios para profesionales y aficionados.', 'https://example.com/logos/dewalt.png', 'https://www.dewalt.com', 1, 1),
(2, 'Bosch', 'Marca reconocida por herramientas eléctricas, electrodomésticos y tecnología industrial.', 'https://example.com/logos/bosch.png', 'https://www.bosch.com', 1, 1),
(3, 'Stanley', 'Líder en herramientas manuales, medidores y productos de almacenamiento.', 'https://example.com/logos/stanley.png', 'https://www.stanleytools.com', 1, 1),
(4, 'Makita', 'Proveedor global de herramientas eléctricas y equipos industriales.', 'https://example.com/logos/makita.png', 'https://www.makitatools.com', 1, 1),
(5, 'Black+Decker', 'Fabricante de herramientas eléctricas, jardinería y electrodomésticos.', 'https://example.com/logos/blackdecker.png', 'https://www.blackanddecker.com', 1, 1),
(6, 'Truper', 'Empresa líder en herramientas manuales, eléctricas y accesorios de ferretería.', 'https://example.com/logos/truper.png', 'https://www.truper.com', 1, 1),
(7, 'Klein Tools', 'Fabricante de herramientas manuales y equipos eléctricos de alta calidad.', 'https://example.com/logos/klein.png', 'https://www.kleintools.com', 1, 1),
(8, 'Hilti', 'Proveedor especializado en herramientas y sistemas de fijación para construcción.', 'https://example.com/logos/hilti.png', 'https://www.hilti.com', 1, 1),
(9, 'Fischer', 'Expertos en soluciones de fijación y anclajes para construcción.', 'https://example.com/logos/fischer.png', 'https://www.fischer.com', 1, 1),
(10, 'RIDGID', 'Marca especializada en herramientas para plomería y construcción.', 'https://example.com/logos/ridgid.png', 'https://www.ridgid.com', 1, 1),
(11, 'Irwin', 'Fabricante de herramientas de corte, sujeción y perforación.', 'https://example.com/logos/irwin.png', 'https://www.irwin.com', 1, 1),
(12, '3M', 'Líder en productos industriales como adhesivos, cintas, abrasivos y más.', 'https://example.com/logos/3m.png', 'https://www.3m.com', 1, 1),
(13, 'Troy-Bilt', 'Especialista en herramientas y equipos de jardinería.', 'https://example.com/logos/troybilt.png', 'https://www.troybilt.com', 1, 1),
(14, 'Husqvarna', 'Fabricante de herramientas para jardinería, agricultura y construcción.', 'https://example.com/logos/husqvarna.png', 'https://www.husqvarna.com', 1, 1),
(15, 'Craftsman', 'Marca confiable en herramientas manuales, eléctricas y almacenamiento.', 'https://example.com/logos/craftsman.png', 'https://www.craftsman.com', 1, 1),
(16, 'Milwaukee', 'Proveedor de herramientas eléctricas y accesorios de alta calidad.', 'https://example.com/logos/milwaukee.png', 'https://www.milwaukeetool.com', 1, 1),
(17, 'Metabo', 'Especialista en herramientas eléctricas y accesorios industriales.', 'https://example.com/logos/metabo.png', 'https://www.metabo.com', 1, 1),
(18, 'Bostitch', 'Fabricante de herramientas de fijación como engrampadoras y clavos.', 'https://example.com/logos/bostitch.png', 'https://www.bostitch.com', 1, 1),
(19, 'Simpson Strong-Tie', 'Líder en soluciones de anclaje y conectores estructurales.', 'https://example.com/logos/simpson.png', 'https://www.strongtie.com', 1, 1),
(20, 'Paslode', 'Fabricante de herramientas de fijación neumáticas y a gas.', 'https://example.com/logos/paslode.png', 'https://www.paslode.com', 1, 1),
(21, 'Assa Abloy', 'Líder mundial en soluciones de apertura de puertas, incluyendo cerraduras y sistemas de seguridad.', 'https://example.com/logos/assaabloy.png', 'https://www.assaabloy.com', 1, 1),
(22, 'Mul-T-Lock', 'Fabricante de sistemas de cerraduras de alta seguridad.', 'https://example.com/logos/multlock.png', 'https://www.mul-t-lock.com', 1, 1),
(23, 'Medeco', 'Especialistas en cerraduras de alta seguridad y sistemas de llaves controladas.', 'https://example.com/logos/medeco.png', 'https://www.medeco.com', 1, 1),
(24, 'Kwikset', 'Fabricante de cerraduras residenciales y sistemas de llaves inteligentes.', 'https://example.com/logos/kwikset.png', 'https://www.kwikset.com', 1, 1),
(25, 'Schlage', 'Marca reconocida en cerraduras residenciales y comerciales.', 'https://example.com/logos/schlage.png', 'https://www.schlage.com', 1, 1),
(26, 'Yale', 'Pioneros en cerrajería con más de 180 años de experiencia.', 'https://example.com/logos/yale.png', 'https://www.yale.com', 1, 1),
(27, 'Master Lock', 'Fabricante líder de candados y soluciones de seguridad.', 'https://example.com/logos/masterlock.png', 'https://www.masterlock.com', 1, 1),
(28, 'ABUS', 'Especialistas en candados y sistemas de seguridad de alta calidad.', 'https://example.com/logos/abus.png', 'https://www.abus.com', 1, 1),
(29, 'EVVA', 'Fabricante austriaco de sistemas de cerraduras de alta seguridad.', 'https://example.com/logos/evva.png', 'https://www.evva.com', 1, 1),
(30, 'Sargent', 'Proveedor de soluciones de seguridad mecánicas y electrónicas.', 'https://example.com/logos/sargent.png', 'https://www.sargentlock.com', 1, 1);
...
(1, 'Unidad', 'und', 'Producto vendido por unidades individuales', 1, 1),
(2, 'Juego', 'kit', 'Conjunto de piezas que se venden como un paquete completo', 1, 1),
(3, 'Paquete', 'pqte', 'Varios artículos empaquetados juntos como una unidad de venta', 1, 1),
(4, 'Caja', 'caja', 'Contenedor con múltiples unidades, paquetes o juegos', 1, 1),
(5, 'Docena', 'doc', 'Conjunto de doce unidades del mismo producto', 1, 1),
(6, 'Metro lineal', 'ml', 'Medida de longitud en metros', 1, 1),
(7, 'Metro cuadrado', 'm²', 'Medida de área o superficie', 1, 1),
(8, 'Kilogramo', 'kg', 'Medida de peso/masa equivalente a 1000 gramos', 1, 1),
(9, 'Gramo', 'g', 'Medida de peso/masa', 1, 1),
(10, 'Litro', 'lt', 'Medida de volumen para líquidos', 1, 1);
